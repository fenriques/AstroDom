...
class SortFilterProxyModel(QSortFilterProxyModel):
    ...
    def filterAcceptsRow(self, sourceRow, sourceParent):
        ...
        if self.ui.lineEditExposure.text() and bReturn == True:
            if (operatorExposure == '=' and int(self.ui.lineEditExposure.text()) == dataExposure):
                bReturn = True
            elif (operatorExposure == '<' and int(self.ui.lineEditExposure.text()) > dataExposure):
                bReturn = True
            elif (operatorExposure == '>' and int(self.ui.lineEditExposure.text()) < dataExposure):
                bReturn = True
            else:
