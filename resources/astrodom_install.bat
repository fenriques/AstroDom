...
echo.
echo ----------------------------------------
echo Installing astrodom
echo ----------------------------------------
echo.
echo Installing AstroDom  >> install.log
venv\Scripts\activate && python -m pip install astrodom --upgrade --no-cache-dir >> install.log

echo.
echo ----------------------------------------
echo Installed astrodom successfully
